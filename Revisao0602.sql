...
CREATE TABLE ENDERECO_CLI(ID_CLIENTE NUMBER PRIMARY KEY,
                    NOME VARCHAR2 (100),
                    CEP VARCHAR2 (12),
                    ID_BAIRRO NUMBER);
                    
ALTER TABLE ENDERECO_CLI ADD CONSTRAINT FK_END_CLIENTE FOREIGN KEY (ID_BAIRRO) REFERENCES BAIRRO (ID_BAIRRO);

INSERT INTO ENDERECO_CLI (ID_CLIENTE, NOME, CEP, ID_BAIRRO) VALUES (1, 'JAO', '09345678', 1); --ERRO POIS NÃO TEM DADOS EM BAIRRO
INSERT INTO PAIS VALUES (1, 'BRASIL');

INSERT INTO ESTADO VALUES (1, 'SAO PAULO', 1);
INSERT INTO CIDADE VALUES (1, 'SAO PAULO', 1);
INSERT INTO BAIRRO VALUES (1, 'BELA VISTA', 1);
INSERT INTO endereco_cli VALUES (1, 'JAO', '09234567', 1);
